...
const ProfileSection = () => {
  ...
  const hairColors = ['2c1b18', '724133', 'a55728', 'd6863b', 'f59797', 'c93305', 'e9b4b4', '724133'];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="mb-8 md:mb-10 flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
        ...
        <div>
            <h2 className="text-2xl md:text-3xl font-black text-slate-900 uppercase italic tracking-tighter">Profil Saya</h2>
            <p className="text-slate-400 font-bold text-[10px] md:text-xs uppercase tracking-widest">Atur identitas dan kustomisasi avatar unikmu</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-start">
        
        {/* KOLOM KIRI: SETTINGS FORM (70%) */}
        <div className="lg:col-span-8 space-y-6 md:space-y-8 order-2 lg:order-1">
          ...
          <div className="bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-xl border border-slate-100 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-6 md:mb-8 relative">
              ...
              <h4 className="text-lg md:text-xl font-black text-slate-900 uppercase italic tracking-tighter">Informasi Dasar</h4>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 relative">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Nama Tampilan</label>
                <input 
                  type="text" 
                  value={name} 
              ...
              <div className="space-y-2 opacity-80">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-2">Email (Read Only)</label>
          ...
          <div className="bg-white p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-xl border border-slate-100">
            <div className="flex items-center gap-3 mb-6 md:mb-8">
              ...
              <h4 className="text-lg md:text-xl font-black text-slate-900 uppercase italic tracking-tighter">Kustomisasi Karakter</h4>
            </div>
            ...
            <div className="space-y-8 md:space-y-10">
              ...
              <div>
                <div className="flex items-center gap-2 mb-4 text-slate-500">
                  <LayoutGrid size={16} /><span className="text-[10px] md:text-xs font-black uppercase tracking-widest">Pilih Karakter Dasar</span>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                ...
                <div className="space-y-6">
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 text-slate-500">
                            <Scissors size={16} /><span className="text-[10px] md:text-xs font-black uppercase tracking-widest">Gaya Rambut</span>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 text-slate-500">
                            <Smile size={16} /><span className="text-[10px] md:text-xs font-black uppercase tracking-widest">Ekspresi Wajah</span>
                        </div>
                        <div className="grid grid-cols-2 gap-2">
                            {mouthStyles.map(m => (
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 text-slate-500">
                            <Sparkles size={16} /><span className="text-[10px] md:text-xs font-black uppercase tracking-widest">Jenis Pakaian</span>
                        </div>
                ...
                <div className="space-y-6 md:space-y-8">
                    <div>
                        <span className="text-[10px] md:text-xs font-black uppercase tracking-widest text-slate-500 block mb-4 italic">Warna Rambut</span>
                    ...
                    <div>
                        <span className="text-[10px] md:text-xs font-black uppercase tracking-widest text-slate-500 block mb-4 italic">Warna Pakaian</span>
                        <div className="flex flex-wrap gap-2 md:gap-3">
                            {clothesColors.map(c => (
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-4 text-slate-500">
                            <Palette size={16} /><span className="text-[10px] md:text-xs font-black uppercase tracking-widest">Warna Latar</span>
                        </div>
                        <div className="flex flex-wrap gap-2 md:gap-3">
                            {bgColors.map(c => (
        ...
        <div className="lg:col-span-4 lg:sticky lg:top-32 space-y-6 order-1 lg:order-2">
          <div className="bg-white p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] shadow-2xl border border-slate-100 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <span className="px-4 py-1.5 bg-purple-600 text-white rounded-full text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] shadow-lg shadow-purple-200">
              {userData?.role || 'Customer'} Member
            </span>
            
            <h3 className="text-2xl md:text-3xl font-black text-slate-900 uppercase italic tracking-tighter mt-6 truncate w-full px-2">
              {name || "Nama User"}
            </h3>
            <p className="text-slate-400 font-bold text-[10px] md:text-xs uppercase tracking-widest mt-1 mb-8 truncate w-full px-4">{userData?.email}</p>
          ...
          <div className="bg-gradient-to-br from-indigo-600 to-purple-700 p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] text-white shadow-xl relative overflow-hidden group">
              ...
              <p className="text-[10px] md:text-xs font-bold text-white/80 leading-relaxed relative">
                Avatar kamu akan digunakan di seluruh platform Raly Ticket, termasuk pada e-ticket dan komentar event.
              </p>
          </div>
        </div>
