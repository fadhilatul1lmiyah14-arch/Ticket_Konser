        ...
        <div className="bg-transparent min-h-screen py-8 md:py-12 px-4 print:bg-white print:p-0">
          <main className="max-w-2xl mx-auto">
            ...
            <div className="text-center mb-10 print:hidden">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-emerald-500/10 rounded-full border border-emerald-500/20 mb-6 backdrop-blur-md">
            ...
            <div className="relative animate-in fade-in slide-in-from-bottom-8 duration-700">
              <div className="relative bg-slate-900/60 backdrop-blur-2xl rounded-[2.5rem] overflow-hidden border border-slate-700 shadow-2xl print:shadow-none print:border-black print:rounded-none">
                ...
                <div className="p-8 md:p-12 pt-4 bg-black/40 print:bg-white">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="mt-8 text-center">
                      ...
                      <div className="inline-flex items-center gap-2 px-6 py-2 bg-slate-800/80 backdrop-blur-md rounded-full border border-slate-700 print:border print:border-black print:bg-white">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-12 print:hidden">
                    <button onClick={downloadQRCode} className="flex-1 flex items-center justify-center gap-3 text-[11px] font-black uppercase text-white bg-slate-800/60 backdrop-blur-md border border-slate-700 py-4 rounded-2xl hover:bg-slate-700 transition-all active:scale-95">
                ...
                <div className="bg-black/60 py-4 px-10 border-t border-slate-800/50 flex justify-between items-center print:bg-black">
